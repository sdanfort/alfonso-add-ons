...
t(1)=cputime;
[cubature,PadL] = pdcub(n,xyrange,@funct);
t(2)=cputime;
...
% FUNCTION SAVED ON A FILE "funct.m" WITH ADDITIONAL PARAMETERS 
% (e.g. TO CHOOSE THE FUNCTION IN A SET OF FUNCTIONS, SEE "@funct.m").

t(1)=cputime;
[cubature,PadL] = pdcub(n,xyrange,@funct,1);
t(2)=cputime;
